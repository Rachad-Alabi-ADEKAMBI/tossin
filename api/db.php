...
// db.php
/*
$host = 'sql112.infinityfree.com';      // serveur MySQL
$db   = 'if0_40718880_gbemiro_gestion'; // nom de la base de données
$user = 'if0_40718880'; // nom d'utilisateur MySQL
$pass = 'zJswv0QlcU2Na';   // mot de passe MySQL
