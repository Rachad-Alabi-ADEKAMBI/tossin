        ...
        <main class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        <a href="creances.html" class="flex items-center p-3 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                            <i class="fas fa-plus-circle text-blue-600 mr-3"></i>
                            <span class="text-blue-700 font-medium">Ajouter une créance</span>
                        </a>
                        <a href="commandes.html" class="flex items-center p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
                            <i class="fas fa-shopping-cart text-green-600 mr-3"></i>
                            <span class="text-green-700 font-medium">Nouvelle commande</span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center p-3 border-l-4 border-blue-500 bg-blue-50">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Client ABC - 150,000 XOF</p>
                            </div>
                        </div>
                        <div class="flex items-center p-3 border-l-4 border-green-500 bg-green-50">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">CMD-025 créée</p>
                            </div>
                        </div>
                    </div>
                </div>
