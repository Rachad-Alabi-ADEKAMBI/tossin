                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="sale in paginatedSales" :key="sale.id" class="hover:bg-gray-50">
                                        ...
                                        <!-- 🔹 Colonne commentaire -->
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 italic" data-label="Commentaire">
                                            <span v-if="sale.comment">{{ sale.comment }}</span>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" data-label="Actions">
                                            <div class="flex space-x-3">
                                                <button
                                                    @click="editSale(sale)"
                                                    :disabled="sale.status === 'Annulé'"
                                                    :class="sale.status === 'Annulé'
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div v-for="(line, index) in saleForm.lines" :key="index"
                                        ...
                                        <div>
                                            ...
                                            <input v-model.number="line.quantity" type="number" min="1" step="0.01" required
                                                @input="validateQuantity(index)"
                                                :placeholder="line.quantity > 0 ? '' : '0'"
                                                class="w-full px-2 py-2 border border-gray-300 rounded text-sm">
                                        </div>
                ...
                <div class="flex items-center justify-center min-h-screen p-4">
                    <div class="bg-white rounded-xl shadow-xl max-w-3xl w-full p-6 max-h-screen overflow-y-auto">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Affichage du commentaire dans le récapitulatif -->
                            <div v-if="saleForm.comment" class="bg-yellow-50 p-4 rounded-lg">
                                <p class="text-sm text-gray-600">Commentaire</p>
                                <p class="text-lg font-semibold">{{ saleForm.comment }}</p>
                            </div>
                            ...
                            <div class="flex justify-end space-x-3 mt-6">
                                ...
                                <button type="button" @click="processSale" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Profil client</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="sale in paginatedSales" :key="sale.id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap" data-label="Client">
                                            <div class="text-sm font-medium text-gray-900">{{ sale.buyer }}</div>
                                            <!-- Affichage du commentaire sous le nom du client -->
                                            <div v-if="sale.comment" class="text-xs text-gray-500 italic mt-1">{{ sale.comment }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" data-label="Date">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" data-label="Profil client">
                                            <button @click="showClientProfile(sale)" class="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg text-xs font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2">
